...
The image is pinned to v0.5, so future app releases require changing the image tag. Choose a moving stable channel before Community Apps submission if desired. The release workflow never updates running containers.
